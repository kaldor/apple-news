...
class Theme {
	...
	private static function initialize_options() {
		self::$options = array(
			...
			'darkmode_blockquote_background_color'   => array(
				'default' => '#e1e1e1',
				'label'   => __( 'Dark Mode Blockquote background color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_blockquote_border_color'       => array(
				'default' => '#4f4f4f',
				'label'   => __( 'Dark Mode Blockquote border color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_blockquote_color'              => array(
				'default' => '#4f4f4f',
				'label'   => __( 'Dark Mode Blockquote color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_body_background_color'         => array(
				'default' => '#000000',
				'label'   => __( 'Dark Mode Body background color', 'apple-news' ),
				'type'    => 'color',
			),
			'body_color'                             => array(
				'default' => '#4f4f4f',
			...
			'darkmode_body_color'                    => array(
				'default' => '#ffffff',
				'label'   => __( 'Dark Mode Body font color', 'apple-news' ),
				'type'    => 'color',
			),
			'body_font'                              => array(
				'default' => 'AvenirNext-Regular',
			...
			'darkmode_body_link_color'               => array(
				'default' => '#428bca',
				'label'   => __( 'Dark Mode Body font hyperlink color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_byline_color'                  => array(
				'default' => '#7c7c7c',
				'label'   => __( 'Dark Mode Byline font color', 'apple-news' ),
				'type'    => 'color',
			),
			'byline_font'                            => array(
			...
			'darkmode_caption_color'                 => array(
				'default' => '#4f4f4f',
				'label'   => __( 'Dark Mode Caption font color', 'apple-news' ),
				'type'    => 'color',
			),
			'caption_font'                           => array(
			...
			'darkmode_dropcap_background_color'      => array(
				'default' => '',
				'label'   => __( 'Dark Mode Drop cap background color', 'apple-news' ),
				'type'    => 'color',
			),
			'dropcap_color'                          => array(
				'default' => '#4f4f4f',
			...
			'darkmode_dropcap_color'                 => array(
				'default' => '#4f4f4f',
				'label'   => __( 'Dark Mode Drop cap font color', 'apple-news' ),
				'type'    => 'color',
			),
			'dropcap_font'                           => array(
			...
			'darkmode_header1_color'                 => array(
				'default' => '#333333',
				'label'   => __( 'Dark Mode Header 1 font color', 'apple-news' ),
				'type'    => 'color',
			),
			'header1_font'                           => array(
				'default' => 'AvenirNext-Bold',
			...
			'darkmode_header2_color'                 => array(
				'default' => '#333333',
				'label'   => __( 'Dark Mode Header 2 font color', 'apple-news' ),
				'type'    => 'color',
			),
			'header2_font'                           => array(
				'default' => 'AvenirNext-Bold',
			...
			'darkmode_header3_color'                 => array(
				'default' => '#333333',
				'label'   => __( 'Dark Mode Header 3 font color', 'apple-news' ),
				'type'    => 'color',
			),
			'header3_font'                           => array(
				'default' => 'AvenirNext-Bold',
			...
			'darkmode_header4_color'                 => array(
				'default' => '#333333',
				'label'   => __( 'Dark Mode Header 4 font color', 'apple-news' ),
				'type'    => 'color',
			),
			'header4_font'                           => array(
				'default' => 'AvenirNext-Bold',
			...
			'darkmoe_header5_color'                  => array(
				'default' => '#333333',
				'label'   => __( 'Dark Mode Header 5 font color', 'apple-news' ),
				'type'    => 'color',
			),
			'header5_font'                           => array(
				'default' => 'AvenirNext-Bold',
			...
			'darkmode_header6_color'                 => array(
				'default' => '#333333',
				'label'   => __( 'Dark Mode Header 6 font color', 'apple-news' ),
				'type'    => 'color',
			),
			'header6_font'                           => array(
				'default' => 'AvenirNext-Bold',
			...
			'darkmode_monospaced_color'              => array(
				'default' => '#4f4f4f',
				'label'   => __( 'Dark Mode Monospaced font color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_pullquote_border_color'        => array(
				'default' => '#53585f',
				'label'   => __( 'Dark Mode Pull quote border color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_pullquote_color'               => array(
				'default' => '#53585f',
				'label'   => __( 'Dark Mode Pull quote color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_table_body_background_color'   => array(
				'default' => '#fafafa',
				'label'   => __( 'Dark Mode Table body background color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_table_body_color'              => array(
				'default' => '#4f4f4f',
				'label'   => __( 'Dark Mode Table body font color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_table_border_color'            => array(
				'default' => '#4f4f4f',
				'label'   => __( 'Dark Mode Table border color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_table_header_background_color' => array(
				'default' => '#fafafa',
				'label'   => __( 'Dark Mode Table header background color', 'apple-news' ),
				'type'    => 'color',
			),
			...
			'darkmode_table_header_color'            => array(
				'default' => '#4f4f4f',
				'label'   => __( 'Dark Mode Table header font color', 'apple-news' ),
				'type'    => 'color',
			),
		...
		self::$groups = array(
			...
			'body'            => array(
				...
				'settings' => array(
					...
					'darkmode_body_color',
					'body_link_color',
					'darkmode_body_link_color',
					'body_background_color',
					'darkmode_body_background_color',
					'body_orientation',
				),
			),
			'dropcap'         => array(
				...
				'settings' => array(
					...
					'darkmode_dropcap_background_color',
					'dropcap_color',
					'darkmode_dropcap_color',
					'dropcap_font',
			...
			'blockquote'      => array(
				...
				'settings' => array(
					...
					'blockquote_tracking',
					'blockquote_color',
					'darkmode_blockquote_color',
					'blockquote_border_style',
					'blockquote_border_color',
					'darkmode_blockquote_border_color',
					'blockquote_border_width',
					'blockquote_background_color',
					'darkmode_blockquote_background_color',
				),
			),
			'table'           => array(
				...
				'settings' => array(
					'table_border_color',
					'darkmode_table_border_color',
					'table_border_style',
					'table_border_width',
					'table_body_background_color',
					'darkmode_table_body_background_color',
					'table_body_color',
					'darkmode_table_body_color',
					'table_body_font',
					...
					'darkmode_table_header_background_color',
					'table_header_color',
					'darkmode_table_header_color',
					'table_header_font',
